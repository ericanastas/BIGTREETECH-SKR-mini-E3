...
#define STRING_CONFIG_H_AUTHOR "Eric Anastas" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Satsana Ender 3"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -1.85 }
...
#define Y_MIN_POS -16
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 25 // Allow head to move off right side of bed for ABL probing
